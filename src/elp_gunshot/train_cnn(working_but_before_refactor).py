...
# CONFIG
# =========================
MODEL = os.getenv("MODEL", "model2")    # model1 / model2 / model3
...
# Datasets
# =========================
train_ds = load_dataset(TRAIN_TF, shuffle=True, repeat=True)
val_ds = load_dataset(VAL_TF, shuffle=False, repeat=True)
...
model.compile(
    ...
    #optimizer=tf.keras.optimizers.Adam(learning_rate=LEARNING_RATE, beta_2=0.95),
